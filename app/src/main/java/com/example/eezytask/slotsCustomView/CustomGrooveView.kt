...
class CustomGrooveView : View{
    ...
    private val grooveDepth:Int=Utils.dpToPx(14f,context!!)
    private val grooveHeight :Int=Utils.dpToPx(10f,context!!)
    private val grooveHeightCenter :Int=Utils.dpToPx(4f,context!!)
    private val grooveDepthCenter :Int=Utils.dpToPx(4f,context!!)
